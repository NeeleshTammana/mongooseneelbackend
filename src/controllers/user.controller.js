...
const registerUser = asyncHandler(async (req, res) => {
    ...
    console.log("Received files:", req.files); // Debugging multer  
    ...
    // 3️⃣ Check if the user already exists (by email or username)  
    ...
    // 4️⃣ Handle file uploads using multer  
    ...
    const user = await User.create({
        fullName,
        avatar: avatar.url, // Uploaded avatar URL  
    ...
    // 7️⃣ Fetch created user (excluding sensitive data)  
